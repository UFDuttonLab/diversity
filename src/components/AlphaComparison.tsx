      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <div className="mt-3 p-3 bg-educational-success rounded-lg">
              <div className="text-xs space-y-1">
                <p><strong>Key insight:</strong> Simpson diversity (1-D) ranges 0-1, Inverse Simpson (1/D) gives "effective species number" - tells you how many equally-abundant species would give the same diversity.</p>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <div className="mt-3 p-3 bg-educational-info rounded-lg">
              <div className="text-xs space-y-1">
                <p><strong>Key insight:</strong> These metrics correct richness for sample size. If lines cross, different sample-size corrections give different answers about which community is most diverse.</p>
              </div>
            </div>
          </CardContent>
        </Card>
